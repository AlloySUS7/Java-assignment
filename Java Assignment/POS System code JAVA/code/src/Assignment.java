...
// SYSTEM STARTS HERE ===================================================== !!!!!        
    ...
    public static void titleScreen() {
        ...
        ArrayList<Customer> cusLogin = new ArrayList();
  ...
  public static ArrayList<Game> filereadingGame(ArrayList<Game> gameList){
    ...
    //Adding new game(ONLY FOR STAFF)================================================================================
     ...
     public static void deleteGame(){
         ...
         String filePath = "available_games.txt";
         Game game = new Game();
          try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((currentLine = reader.readLine()) != null) {
                ...
                // Assuming gameId is in the first column (index 0) and gameName is in the second column (index 1)
                game.setGameID(parts[0]);
                game.setGameName(parts[1]); 
        ...
        String gameIdToDelete = sc.nextLine();
        sc.close();

        // Define the file path
        

        // Read the file and remove the desired row
        try {
            ...
            while ((currentLine = reader.readLine()) != null) {
                String[] parts = currentLine.split("\\|");
                String gameId = parts[0].trim(); // Assuming game ID is in the first column

                if (gameId.equals(gameIdToDelete)) {
                    found = true;
            ...
            if (!found) {
                System.out.println("Game ID not found in the file.");
            } else {
                // Rename the temp file to the original file
                if (tempFile.renameTo(inputFile)) {
                    System.out.println("Game record deleted successfully.");
                } else {
